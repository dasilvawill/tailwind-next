...
const fileItem = tv({
  ...
  slots: {
    ...
    icon: 'rounded-full border-4 border-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: ''
  },
    ...
    <div className={container()}>
      ...
      {state === 'error' ? (
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button type="button" className="text-sm font-semibold text-error-700 dark:text-error-400 hover:text-error-900 dark:hover:text-error-300">
            Try again
          </button>
        </div>
