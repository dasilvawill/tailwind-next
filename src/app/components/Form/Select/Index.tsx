    ...
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.SelectContent
          ...
          position="popper"
          sideOffset={8}
          className="z-10 w-[--radix-select-trigger-width] overflow-hidden rounded-lg border border-zinc-300	bg-white shadow-sm animate-slideDownAndFade dark:bg-zinc-800 dark:border-zinc-700"
        >
